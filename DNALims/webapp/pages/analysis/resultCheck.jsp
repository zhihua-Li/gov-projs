...
<%--
	          <td>复核状态：</td>
	          <td>
	        	<s:select name="boardInfoQuery.reviewStatus" cssClass="select_one" list="reviewStatusList" listKey="dictKey" listValue="dictValue"
		      ...
		      <tbody id="listTbody">
		        <s:iterator value="boardInfoList" status="su">
					<tr>
						...
						<td>
							<a href="javascript:void(0)" onclick="viewSampleGenes('<s:property value="id"/>');"><img src="<%=path %>/images/view_text_32.png" width="24" height="24" style="vertical-align:middle;" alt="查 看" title="查 看"/></a>
						</td>
					</tr>
		     	</s:iterator>
		      </tbody>
