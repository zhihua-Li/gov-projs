...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	$(document).ready(function(){
		...
		$.ajax({
			type: "get",
			url: "<%=path %>/pages/system/querySysMenus.action?operateType=2&sysRole.id=" + $("#sysRoleId").val(),
			dataType: "json",
	...
	<div class="main">
		  ...
		  <div class="box_three">
		    ...
		    <s:form action="submitSysRole" id="submitSysRoleForm" name="submitSysRoleForm" method="post">
		    	<s:hidden name="sysRole.id" id="sysRoleId"/>
			      ...
			      <div class="height_one"></div>
					<table class="table_two width2 floatL marginL1">
				        ...
				        <tr>
				          <td>角色代码：</td>
				          <td>
				          	<s:textfield name="sysRole.roleType" id="roleTypeText" cssClass="text_one" readonly="true" />
				          </td>
				        </tr>
				        <tr>
				          <td>描 述：</td>
